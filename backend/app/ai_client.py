...
REFLECTION_PROMPT = """
    ...
    3. Sampaikan bahwa kita akan lanjut ke pertanyaan berikutnya.
...
def reflection_service(name: str, question: str, answer: str, system_prompt: str = REFLECTION_PROMPT) -> Reflection:
    try:
        contents = f"""
            Pertanyaan: {question}
